...
export default function Grid() {
    const productData: ProductInterface[] = [
        ...
        { name: "Ultricies condimentum imperdiet", image: "/grid (9).png" },
    ...
    return (
        <div>
         <div className="lg:h-[286px] mt-5 h-[120px] md:h-[220px] w-full bg-[#F6F5FF] flex flex-col items-start justify-center">
            ...
            <div className="lg:h-[44px] mt-24 mb-20 h-[35px] md:h-[40px] xl:w-[full] flex lg:flex-row flex-col gap-3 lg:gap-0 justify-around ">
                <div className="pl-2">
