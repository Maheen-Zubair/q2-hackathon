  ...
  return (
    <div className=" flex justify-center items-center  elg:ml-[10%] overflow-hidden">
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-x-10 justify-center  gap-y-6 ml-5 lg:ml-0">
        <div className="xl:w-[420px] lg:w-full lg:h-full xl:h-[270px] w-[90%] h-[200px]  bg-[#FFF6FB] flex flex-col justify-center px-8 lg:gap-2 shadow-sm shadow-gray-300">
        ...
        <div key={index} className="xl:w-[420px] lg:w-full lg:h-[240px] xl:h-[270px] w-[90%] h-[200px] bg-[#EEEFFB] flex flex-col justify-center px-8 shadow-sm shadow-gray-300">
