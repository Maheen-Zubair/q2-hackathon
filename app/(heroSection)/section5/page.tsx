...
const GetProductData = () => {
  const res = client.fetch(`*[_type == "product" && "discount" in tags]{
      _id,
  name,
  price,
  ...
  return (
    <div className="mainContainer pt-24 max-w-full overflow-hidden bg-white flex flex-col justify-center items-center">
      ...
      {product.map((item: Product, index) => (
        <div
          key={index}
          className="subContainer sm:flex-row flex-col pb-8 justify-center items-center lg:w-[60%] md:w-[70%] w-[80%] h-full sm:[300px] md:h-[480px] lg:h-[597px] flex bg-white "
        >
