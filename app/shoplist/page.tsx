...
<div className="lg:h-[286px] mt-5 h-[120px] md:h-[220px] w-full bg-[#F6F5FF] flex flex-col items-start justify-center">
            ...
            <div className="lg:h-[44px] mt-24 mb-20 h-[35px] md:h-[40px] xl:w-[full] flex lg:flex-row flex-col gap-3 lg:gap-0 justify-around px-32">
                <div className="pl-2">
        ...
        <div className="flex flex-col justify-center items-center lg:mt-24 mt-16">
            <div>{(productData.map((item) => (
                <div className="lg:h-[254px] h-[250px] lg:w-[1141px] w-[78%] flex flex-col lg:flex-row gap-3 lg:gap-4 items-center justify-center ml-6">
                    <div><Image className="" width={313} height={217} src={item.image} alt={item.name}></Image></div>
                    <div className="flex flex-col lg:gap-3 gap-0.5">
                        <div className="flex items-center lg:gap-6 gap-3">
                            ...
                            <p className="lg:text-[18px] text-[10px] md:text-[13px] text-[#9295AA] lg:h-[46px] lg:w-[591px] w-[455px] overflow-hidden">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.</p>
                    <div><Image className="" src={logos} height={34} width={144} alt="logos" ></Image></div>
                    </div>
                </div>
            )))}</div>
                    <Section8/>
