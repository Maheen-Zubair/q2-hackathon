            ...
            <div className="part2 sm:w-[50%] flex flex-col md:gap-6  ">
              ...
              <ul className="list-non flex flex-col md:gap-2 ">
                ...
                <div className="flex gap-3  items-center">
                  <button className=" md:mt-6 mt-3   h-[28px] w-[163px] sl:h-[50px] text-white bg-[#FB2E86] rounded-[2px] hover:bg-[#d73078]  sl:text-[17px] leading-[19.92px] tracking-[2%] hover:shadow-black hover:shadow-sm">
                    Add To Cart
                  </button>
