...
export default function Contact() {
  return (
    <div className="min-h-screen pt-24 pb-24 bg-white flex flex-col justify-center items-center p-4">
       <div className="lg:h-[286px] h-[120px] md:h-[220px] w-full bg-[#F6F5FF] flex flex-col items-start justify-center">
            <div className=" flex flex-col items-start justify-center lg:pl-28 pl-10 md:pl-16">
                <h1 className="lg:text-[36px] text-[20px] md:text-[28px] font-bold text-[#101750]">Contact Us</h1>
                <p className="text-black lg:text-[16px] text-[12px] md:text-[14px] ">Home . Pages <span className="text-[#FB2E86]">. Contact Us</span></p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-[#8A8FB9]">
              Learn more about our services and collaboration offerings. We aim to provide top-notch solutions and build strong client relationships.
            </p>
